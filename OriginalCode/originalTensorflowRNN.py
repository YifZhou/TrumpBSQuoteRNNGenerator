...
class PTBModel(object):
  ...
  def __init__(self, is_training, config):
    ...
    with tf.device("/cpu:0"):
      ...
      embeddedLookUp = tf.nn.embedding_lookup(embedding, self._input_data)
      inputs = tf.split(1, num_steps, embeddedLookUp)
    ...
    loss = seq2seq.sequence_loss_by_example([logits], [tf.reshape(self._targets, [-1])], [tf.ones([batch_size * num_steps])], vocab_size)
...
def main(unused_args):
  FLAGS.data_path = '/Users/Killian1/Development/TensorFlowProject/rnnInputData'
